window.discDeliveryData = {
	...
	gallerySlides: [
		{ label: "Disc Delivery Box", caption: "Monthly Disc Delivery box" },
		{ label: "Signed CD + Art Card", caption: "Signed CD, artist card, and inserts" },
		{ label: "Mystery Album Reveal", caption: "Album stays hidden until unboxing" },
		{ label: "Full Edition Contents", caption: "Complete monthly edition layout" }
	],
	membershipPlans: [
		{
			id: "monthly",
			...
			price: "€29.99",
			subprice: "per month",
			description: "New music every month. Stay as long or as little as you like.",
			saving: "",
			checkoutUrl: "checkout.html?plan=monthly"
		},
		{
			id: "three-month",
			label: "3 Month Plan",
			...
			description: "A season of discovery, paid upfront at a better rate.",
			saving: "Save 5%",
			checkoutUrl: "checkout.html?plan=three-month"
		},
		{
			id: "six-month",
			label: "6 Month Plan",
			...
			description: "Six months of hand-selected independent music, prepaid.",
			saving: "Save 11%",
			checkoutUrl: "checkout.html?plan=six-month"
		},
		{
			id: "twelve-month",
			label: "12 Month Plan",
			...
			description: "A full year of new music — and our best monthly rate.",
			saving: "Save 17%",
			checkoutUrl: "checkout.html?plan=twelve-month"
		}
	],
	editions: [
		{
